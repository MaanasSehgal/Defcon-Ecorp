...
const Page = () => {
  ...
  function handleDownloadClick() {
    ...
    setTimeout(() => {
      setHiddenUsernameState(
        "animate-pulse p-2 text-gray-500 text-sm opacity-25"
      );
    }, 3000);
    setTimeout(() => {
  ...
  return (
    // {user}
    <Box m="10px" className="hover:cursor-default hover:select-none w-[90vw]">
      <Toaster
        toastOptions={{
          className: "",
          style: {
      ...
      />
      <h2 className="text-custom-green text-6xl text-center font-press-start m-8 hover:cursor-default title-font">
        EvilCorp
      </h2>
      {/* HEADER */}
      ...
      >
        ...
        >
          <div className="border-2 border-custom-green moving-border w-full flex">
            <StatBox
              className="bg-transparent"
        ...
        <Box
          ...
          className="bg-transparent"
        >
          <div className="border-2 border-custom-green moving-border flex w-full">
            <StatBox
              className="bg-transparent"
        ...
        <Box gridColumn="span 8" gridRow="span 2" backgroundColor="#000000">
          ...
          <Box height="250px" m="-20px 0 0 -30px">
        ...
        <Box
          ...
          backgroundColor="#000000"
          overflow="auto"
          className="border-2 border-custom-green moving-border"
        >
          <Box
            display="flex"
            justifyContent="space-between"
            ...
            >
              <Box>
                ...
                <Typography
                  color={colors.greenAccent[400]}
                  style={{
                    fontWeight: transaction.clickable ? 700 : "inherit",
                  }}
                >
                  {transaction.user}
                </Typography>
        ...
        {/* ROW 3 */}
        <Box
          className="border-2 border-custom-green moving-border flex flex-col "
          gridColumn="span 4"
          gridRow="span 2"
          backgroundColor="#000000"
          p="30px"
